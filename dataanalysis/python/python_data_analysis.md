...
## 1. 课程介绍
针对科学计算领域的Python开源库生态系统在过去十几年中得到了飞速发展。本次公开课主要介绍如何利用Python进行数据控制、处理、整理、分析等方面的基本要点，包括用于高效解决各种数据分析问题的Python语言和库。希望学员能了解如何运用Python进行数据分析，之后能在课下继续深入并将课程中所介绍的工具高效地运用到实际项目中去。
